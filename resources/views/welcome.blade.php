...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="d-block bg-red-50 col-12 w-auto">
        <a class="alert-primary " href="{{route('user.create')}}">User Register</a>
        <br>
        <a class="alert-primary  " href="{{route('test')}}">Goto Test Page</a>
        <br>
        <a class="alert-primary" href="{{route('container')}}">Goto Container Page</a>
    </div>
